    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "HP Shop uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:5001/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '9e523044-9456-4d65-a919-10105c392f2a',
                    name: data.name || '',
                    email: data.email || '',
